...
function SearchPageContent() {
  ...
  const results = useMemo(() => filterPosts(posts, committedQuery), [posts, committedQuery]);
        ...
        <form onSubmit={handleSubmit} className="mb-6">
          <div className="relative">
            <input
              ...
              className="bg-muted text-foreground focus:bg-muted/70 w-full rounded-full border-none py-3 pr-4 pl-11 text-sm transition-colors duration-200 focus:outline-none"
            />
            <svg
