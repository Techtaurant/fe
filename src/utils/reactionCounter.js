 ...
 */
export function calculateNextLikeCount({ currentLikeCount, currentReaction, nextReaction }) {
  const reactionDelta = {
    like: 1,
    dislike: -1,
    none: 0,
  ...
  return currentLikeCount + reactionDelta[nextReaction] - reactionDelta[currentReaction];
}
 ...
 */
export function resolveReactionState({ override, serverReaction, storedReaction }) {
  if (override) {
    return override;
  }
