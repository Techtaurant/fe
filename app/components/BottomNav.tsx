      ...
      <div className="w-full">
        <div className="bg-background/95 backdrop-blur border-t border-border shadow-lg px-3 py-2">
          <div className="mx-auto max-w-[520px] flex items-center justify-between">
            ...
            >
              <div className="w-11 h-11 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-md transform-gpu transition-[transform,box-shadow,filter] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:brightness-110 hover:shadow-xl hover:scale-105 active:scale-[0.97]">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="currentColor"
